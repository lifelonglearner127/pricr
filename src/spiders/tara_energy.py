...
class TaraEnergyBaseSpider(SpiderBase):
    def submit_zipcode(self, zipcode: str):
        iframe_element = self.wait_until('dnn_ctr1023_IFrame_htmIFrame')
        self.client.switch_to.frame(iframe_element)
        zipcode_element = self.client.find_element_by_id('txtZipCode')
...
class TaraEnergySpider(TaraEnergyBaseSpider):
    name = 'Tara Energy'
    REP_ID = 'TARA'
    base_url = 'https://www.taraenergy.com/'
